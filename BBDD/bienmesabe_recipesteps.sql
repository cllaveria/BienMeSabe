...
CREATE TABLE `recipesteps` (
  ...
  PRIMARY KEY (`STEP_ID`),
  KEY `fk_recipe_id_recipesteps` (`RECIPE_ID`),
  CONSTRAINT `fk_recipe_id_recipesteps` FOREIGN KEY (`RECIPE_ID`) REFERENCES `recipe` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
